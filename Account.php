			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="content shadow">
					<div class="modalFont text-center">
						<h1 class="p-3">Hello, <b>
								<?php echo $username ?><img style='margin-left: 5%' src="Icons/person-circle.svg"
									width="50rem" alt="My Account">
							</b></h1>
					</div>
					<div class="modalFont card-body">
						...
						<?php while ($row = mysqli_fetch_array($sql)) {
							...
							<p class="modalFont" style='font-size:160%'><b>
									<?php echo $row["title"] ?> Quiz
								</b></p>
							<p class="modalFont" style='font-size:140%'><b>Best Score:</b>
								<?php echo $row["score"] ?><br><b>Skill Level:</b>
								<?php echo $skill ?>
							</p>
						<?php } ?>
